            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.update-course-offer')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input" class="col-sm-3 col-form-label">Banner Image</label>
                            <div class="col-sm-9">
                                <input type="file" name="image" class="form-control-file" id="horizontal-password-input">
                                <img src="{{asset($single_course->banner_image)}}" alt="" style="height: 150px; width: 150px;"/>
                            </div>
                        </div>
